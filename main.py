...
def attack(char_name: str, char_class: str) -> str:
    """Depict amount of damage according to char class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Depict amount of blocking damage according to char class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Depict special skills according to char class."""
    if char_class == 'warrior':
        return (f'{char_name}'
